...
export const PopularCourses = [
  {
    id: 0,
    title: "Data Science",
    icon: "/asset/course-icon/bg8.jpeg",
    rating: 5,
    duration: 2,
    level: "Beginner",
  },
  {
    id: 1,
    title: "Programming & Development",
    icon: "/asset/course-icon/bg9.jpeg",
    rating: 4,
    duration: 3,
    level: "Intermediate",
  },
  {
    id: 2,
    title: "Artificial Intelligence",
    icon: "/asset/course-icon/bg10.jpeg",
    rating: 3,
    duration: 5,
    level: "Master",
  },
  {
    id: 3,
    title: "Business",
    icon: "/asset/course-icon/bg11.jpeg",
    rating: 5,
    duration: 4,
    level: "Beginner",
  },
  {
    id: 4,
    title: "Autonomous Systems",
    icon: "/asset/course-icon/bg12.jpeg",
    rating: 4,
    duration: 3,
    level: "Beginner",
  },
  {
    id: 5,
    title: "Product Management",
    icon: "/asset/course-icon/bg13.jpeg",
    rating: 3,
    duration: 4,
    level: "Master",
  },
  {
    id: 6,
    title: "Cloud Computing",
    icon: "/asset/course-icon/bg14.jpeg",
    rating: 5,
    duration: 2,
    level: "Intermediate",
  },
...
export const DataSkillsCourses = [
  {
    id: 0,
    title: "Data Science",
    icon: "/asset/course-icon/bg15.jpeg",
    rating: 5,
    duration: 2,
    level: "Beginner",
  },
  {
    id: 1,
    title: "Programming & Development",
    icon: "/asset/course-icon/bg16.jpeg",
    rating: 4,
    duration: 3,
    level: "Intermediate",
  },
  {
    id: 2,
    title: "Artificial Intelligence",
    icon: "/asset/course-icon/bg17.jpeg",
    rating: 3,
    duration: 5,
    level: "Master",
  },
  {
    id: 3,
    title: "Business",
    icon: "/asset/course-icon/bg18.jpeg",
    rating: 5,
    duration: 4,
    level: "Beginner",
  },
...
export const LearnNewSkill = [
  {
    id: 0,
    title: "Data Science",
    icon: "/asset/course-icon/bg19.jpeg",
    rating: 5,
    duration: 2,
    level: "Beginner",
  },
