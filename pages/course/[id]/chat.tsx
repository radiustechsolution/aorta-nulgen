...
const EzzraAiChatPage = () => {
  ...
  useEffect(() => {
    const welcomeMessage: MessageTypes = {
      id: 1,
      text: "Hello! I'm Ezzra AI, your assistant. How can I help you today?",
      sender: "bot",
      timestamp: getCurrentTimestamp(),
      timeago: "Just now",
    };

    setMessages([welcomeMessage]); // Set the welcome message in the state
  }, []);
  ...
  return (
    <section className="w-full text-black flex flex-col h-full">
      {/* Chats area */}
      <div
        ref={chatAreaRef}
      ...
      >
        ...
        {messages.map((msg) => (
          ...
          >
            ...
            <div>
              {msg.sender == "user" ? (
                <div className="h-[28px] w-[28px] rounded-lg border border-bordercolor flex items-center justify-center">
                  <VscEdit size={13} />
                </div>
              ) : (
