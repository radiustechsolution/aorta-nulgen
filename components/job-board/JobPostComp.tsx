...
export const JobPostComp = ({ data }: any) => {
  return (
    <div className=" shadow-sm flex items-center border border-gray-100 justify-between p-4">
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col gap-[3px]">
          <p className="text-[18px] font-[500] text-[#090925]">
            {data.position}
          </p>
          <p className="text-[16px] font-[500] text-[#3f495a]">
            {data.company}
          </p>
      ...
      <div className="hidden items-center cursor-pointer lg:flex gap-1">
